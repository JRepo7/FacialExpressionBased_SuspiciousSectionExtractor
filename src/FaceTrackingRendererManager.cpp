...
void FaceTrackingRendererManager::DetermineExpression()
{
	...
	if (happy_count == 500)
	{
		...
		fprintf(fp, "오른쪽 바깥눈썹  : \t%f", arg / happy_count);
		fprintf(fp, "왼쪽 바깥눈썹 :  \t%f", arg1 / happy_count);
		fprintf(fp, "웃음 정도 :		\t\t%f", arg2 / happy_count);
		fprintf(fp, "왼쪽 입술코너   : \t%f", arg3 / happy_count);
		fprintf(fp, "오른쪽 입술코너  : \t%f", arg4 / happy_count);
