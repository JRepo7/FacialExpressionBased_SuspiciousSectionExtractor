...
void FaceTrackingRendererManager::GetFreqBasedOnEmo()
{
	...
	if (hCnt == 10 || sCnt == 10 || nCnt == 10 || pCnt == 10 || fCnt == 10 || aCnt == 10 || dCnt == 10 && initFront_M)
	{
		if (slidingWindow_M[cursor_m] != slidingWindow_M[cursor_f]) F_FLAG = FALSE;
		else F_FLAG = TRUE;
